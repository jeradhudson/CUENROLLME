...
$facultyroleid = textboxValue("RoleID");
      ...
      if($facultyFname && $facultyLname && $facultyOphone && $facultypass && $facultylocation && $facultyphone && $facultyemail && facultydepid && facultyroleid){
          $sql = "
                      UPDATE Student SET FacFirstName='$facultyFname', FacLastName = '$facultyLname', FacOfficePhone = '$facultyOphone', FacPassword = '$facultypass', FacLocation = '$facultylocation',FacPhone = '$facultyphone', FacEmail = '$facultyemail' DepID = '$facultydepid' RoldID = '$facultyroleid' WHERE FID='$facultyid';
          ";
