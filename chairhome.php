...
<div class="sidebar">
  <a href="chair.php"><i class="fa fa-fw fa-home"></i> Home</a>
  <a href="chairviewfaculty.php"><i class="fa fa-fw fa-wrench"></i> Services</a>
  <a href="chairenrollstudent.php"><i class="fa fa-fw fa-user"></i> Clients</a>
  <a href="chair.php"><i class="fa fa-fw fa-envelope"></i> Contact</a>
</div>
